...
DarkFly now is: <a href="https://github.com/shivamsdk/DarkFly-2019.1">DarkFly-2019.1</a> (generation of DarkFly-tool) Try it.
...
* `pkg install python2`
* `pkg install git`
* `git clone https://github.com/shivamsdk/DarkFly-Tool`
* `cd DarkFly-Tool`
* `python2 install.py`
